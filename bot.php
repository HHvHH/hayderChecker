...
'chat_id'=>$chat_id,  
'text'=>" 
- welcom to hell [$name](tg://user?id=$chat_id) !
- in the checker user name telegram 
- developed by Hayder 🫦 @ss_sz .
",'parse_mode' => "MarkDown", 'disable_web_page_preview' => true,
'reply_markup' => json_encode(['inline_keyboard' => [
[['text' => "-Hayder'", 'url' => "https://t.me/HvvHH"]],
[['text' => "-me channel'", 'url' => "https://t.me/ss_sz"]],
]]) 
]);
}
...
if ($text == "->") {
bot('sendMessage', ['chat_id' => $chat_id, 'text' => "welcome , \nin the checker user name telegram \ndeveloped by Hayder 🫦 @ss_sz . ", 'reply_markup' => json_encode(['resize_keyboard' => true, 'keyboard' => [
[["text" =>"𖠜 Numbers"],["text" =>"𖠜 Requests"]],
[["text" =>"𖠜 Run"],["text" =>"𖠜 Stop"]],
[["text" =>"𖠜 Add Users"],["text" =>"𖠜 Delet User"]],
[["text" =>"𖠜 To Bot ↺ Band"]],
...
'text' => "welcome , \nin the checker user name telegram \ndeveloped by Hayder 🫦 @ss_sz . ",
'reply_markup' => json_encode(['inline_keyboard' => [
[['text'=>"-Hayder 🫦'", 'url' => "https://t.me/HvvHH"],['text'=>"-me channel'", 'url' => "https://t.me/ss_sz"]],
]]) 
]);
unlink('mode');
}
...
'text'=>"⌁ Data Checker Band , king @ss_sz 🐊",
'reply_markup'=>json_encode(['inline_keyboard'=>[
...
bot('sendMessage',['chat_id'=>$chat_id2,'message_id'=>$message_id,
'text'=>"⌁ Data Checker bot , king @ss_sz 🐊",
'reply_markup'=>json_encode(['inline_keyboard'=>[
...
$num8 = $info["num8"];
if ($data == "#Back") {
 bot('editMessagetext',['chat_id'=>$chat_id2,'message_id'=>$message_id,'text' => "welcome , \nin the checker user name telegram \ndeveloped by Hayder 🫦 @ss_sz . ",
'reply_markup'=>json_encode(['inline_keyboard'=>[
